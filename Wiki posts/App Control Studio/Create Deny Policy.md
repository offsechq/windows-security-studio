...
With App Control Studio, you can easily create a Deny base policy by scanning files or folders.
...
- **Policy Name**: Enter a name for the Deny policy. You will be able to use this name to detect it after deployment in the **System Information** section of the App Control Studio.
