# [Comparison of security benchmarks](#comparison-of-security-benchmarks-) 
...
## [Some of the Pitfalls of Relying on Third-Party Benchmarks](#some-of-the-pitfalls-of-relying-on-third-party-benchmarks-) 

###  [Clipboard sharing from guest to host !](#-clipboard-sharing-from-guest-to-host-)
...
###  [Renaming built-in administrator and guest accounts !](#-renaming-built-in-administrator-and-guest-accounts-)
...
###  [Disabling Windows Hello PIN and using traditional passwords instead !](#-disabling-windows-hello-pin-and-using-traditional-passwords-instead-)
...
There are proper policies regarding anti-hammering features that can enhance the security of PINs over passwords. I utilize them in my module and [you can find them here](https://github.com/OFFSECHQ/windows-security-studio#lock-screen).
...
###  [Bad configuration for Early Launch Anti Malware](#-bad-configuration-for-early-launch-anti-malware)
...
That's not even a recommendation, that's the default value! If you use [Harden Windows Security module](https://github.com/OFFSECHQ/windows-security-studio#miscellaneous-configurations) it sets it to **Good Only**, which is the correct recommendation for a secure environment.

<br>

###  [Disabling Windows Error reporting !](#-disabling-windows-error-reporting-)
...
###  [Disabling Cloud Protection!](#-disabling-cloud-protection)
...
###  [Not enabling important Attack Surface Reduction rules](#-not-enabling-important-attack-surface-reduction-rules)
...
## [Aspects that are lacking](#aspects-that-are-lacking-) 

The benchmarks omit many new security features that the [Harden Windows Security module](https://github.com/OFFSECHQ/windows-security-studio) implements.
...
* [Microsoft Defender category](https://github.com/OFFSECHQ/windows-security-studio#microsoft-security-baselines)

* [Miscellaneous Category](https://github.com/OFFSECHQ/windows-security-studio#miscellaneous-configurations)

* [Edge Browser category](https://github.com/OFFSECHQ/windows-security-studio#edge-browser-configurations)

* [TLS Security category](https://github.com/OFFSECHQ/windows-security-studio#tls-security)

* [Lock screen category](https://github.com/OFFSECHQ/windows-security-studio#lock-screen)

* And more

The benchmarks/guidelines suggest using application control or whitelisting, but that's just it, a suggestion, no [comprehensive guide about how to do it](https://github.com/OFFSECHQ/windows-security-studio/wiki/Introduction).
