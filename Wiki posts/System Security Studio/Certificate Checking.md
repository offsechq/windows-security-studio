...
This page in the [Harden System Security App](https://github.com/OFFSECHQ/windows-security-studio/wiki/Harden-System-Security) is dedicated to enumerating every certificate across all stores in the **Local Machine** and **Current User** scopes. Certificates can be sorted, searched, and removed as needed.
