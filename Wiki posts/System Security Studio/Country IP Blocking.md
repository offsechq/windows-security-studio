# Country IP Blocking | System Security Studio
...
Once you have those Firewall rules added, you can [use this method](https://github.com/OFFSECHQ/windows-security-studio/wiki/Event-Viewer#how-to-identify-which-windows-firewall-rule-is-responsible-for-a-blocked-packets) to see if any of the blocked connections were from/to those countries.
