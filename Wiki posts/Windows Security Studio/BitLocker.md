# BitLocker | Windows Security Studio

<p align="center">
</p>

- **[Registry/Cmdlet]** **[Group Policy]** [The app](https://github.com/OFFSECHQ/windows-security-studio/wiki/Windows-Security-Studio) sets up and configures BitLocker [using official documentation](https://learn.microsoft.com/windows/security/information-protection/bitlocker/bitlocker-group-policy-settings), with the most secure configuration and military grade encryption algorithm, XTS-AES-256, to protect the confidentiality and integrity of all information at rest. **[CSP]** [CSP](https://learn.microsoft.com/windows/client-management/mdm/bitlocker-csp#encryptionmethodbydrivetype) **[CSP]** [CSP](https://learn.microsoft.com/windows/client-management/mdm/bitlocker-csp#systemdrivesrequirestartupauthentication)
...
- **[Group Policy]** Disallows standard (non-Administrator) users from changing the BitLocker Startup PIN or password **[CSP]** [CSP](https://learn.microsoft.com/windows/client-management/mdm/bitlocker-csp#systemdrivesdisallowstandarduserscanchangepin)

- **[Group Policy]** [Requires you to choose a PIN that contains at least 10 characters](https://learn.microsoft.com/windows/security/information-protection/bitlocker/bitlocker-group-policy-settings#configure-minimum-pin-length-for-startup) **[CSP]** [CSP](https://learn.microsoft.com/windows/client-management/mdm/bitlocker-csp#systemdrivesminimumpinlength)

- **[Group Policy]** (Only on Physical machines) Enables Hibernate and adds Hibernate to Start menu's power options. **[CSP]** [CSP](https://learn.microsoft.com/windows/client-management/mdm/policy-csp-power#allowhibernate)
...
- **[Registry/Cmdlet]** [Sets Hibernate to full](https://learn.microsoft.com/windows/win32/power/system-power-states#hibernation-file-types)
...
![BitLocker management in Windows Security Studio](https://raw.githubusercontent.com/HotCakeX/.github/b70cfc85f491ca1e80bd00df62bfebeb0f3b7d5b/Pictures/APNGs/Harden%20System%20Security/HardenSystemSecurity_BitLockerManagementDemo.apng)
