# Certificate Checking | Windows Security Studio

<p align="center">
</p>

This page in the [Windows Security Studio App](https://github.com/OFFSECHQ/windows-security-studio/wiki/Windows-Security-Studio) is dedicated to enumerating every certificate across all stores in the **Local Machine** and **Current User** scopes. Certificates can be sorted, searched, and removed as needed.
