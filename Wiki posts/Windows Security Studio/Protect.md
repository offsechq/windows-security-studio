...
The Protect page in the [Windows Security Studio App](https://github.com/OFFSECHQ/windows-security-studio/wiki/Windows-Security-Studio) is a central hub for Applying, Verifying or Removing the security measures. It offers presets with optimal pre-selected categories and sub-categories to streamline the hardening process.
...
![Windows Security Studio protection workflow](https://github.com/user-attachments/assets/fae592a3-3473-4d92-b11f-911094f162c9)
...
After you generate a system report, whether it's a full system report that includes all categories or only contains 1 category, you can import and apply it to any system where Windows Security Studio app is installed.
...
**The great thing about all of this? You can totally automate it, thanks to the new CLI support. [Documentation for CLI usage available here](https://github.com/OFFSECHQ/windows-security-studio/wiki/Windows-Security-Studio#commandline-interface-cli-support).**
