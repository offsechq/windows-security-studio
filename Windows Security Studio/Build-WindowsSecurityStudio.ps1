<#
.SYNOPSIS
    Local build script for Windows Security Studio MSIX package.

.DESCRIPTION
    Builds the Windows Security Studio application locally, creating a signed MSIX package.
...
.EXAMPLE
    .\Build-WindowsSecurityStudio.ps1 -Install
...
# Configuration (matches the Store publisher for Windows Security Studio)
$PackagePublisher = 'CN=520167C9-C63F-4572-841C-0538368FD2C2'
$PackageHashAlgo = 'SHA256'

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "  Windows Security Studio - Local Build" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
...
#region --- Build C++ Components ---
Write-Host "`nBuilding C++ projects..." -ForegroundColor Magenta

# ComManager
Write-Host "  Building ComManager (x64)..." -ForegroundColor Yellow
& $MSBuildPath '.\Components\ComManager\ComManager.slnx' /p:Configuration=Release /p:Platform=x64 /target:"clean;Rebuild" /v:minimal
...
$bundleName = "Windows Security Studio_$version.msixbundle"
