# Microsoft Security Baselines | Windows Security Studio
...
On this page, [the Windows Security Studio app](https://github.com/OFFSECHQ/windows-security-studio/wiki/Windows-Security-Studio) enables you to apply the Microsoft Security Baselines on your system, verify compliance, and remove the applied policies.
...
- Use the **Apply Optional Overrides** toggle button, which is enabled by default, to apply WSS's compatibility-oriented baseline overrides. They are recommended for an improved user experience with Microsoft Security Baselines.
...
> [!NOTE]
> Either when downloading the Security Baseline from Microsoft Servers or when browsing for the zip file manually, the Windows Security Studio app will process it entirely **in memory**, and apply it without writing any temporary files to disk. The same is true for verification or removal processes.
>
...
![Microsoft Security Baselines | Windows Security Studio](https://raw.githubusercontent.com/HotCakeX/.github/refs/heads/main/Pictures/PNG%20and%20JPG/Harden%20System%20Security%20page%20screenshots/Microsoft%20Security%20Baseline.png)
...
>
> Optional overrides can be enabled or disabled before the baseline is applied.
>
